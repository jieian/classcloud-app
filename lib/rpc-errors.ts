...
export const RpcError = {
  ...
  CURRICULUM_SUBJECT_NOT_FOUND:        "CURRICULUM_SUBJECT_NOT_FOUND",
  USER_ALREADY_GRADE_SUBJECT_LEADER:   "USER_ALREADY_GRADE_SUBJECT_LEADER",
  GSL_SLOT_TAKEN:                      "GSL_SLOT_TAKEN",
} as const;
